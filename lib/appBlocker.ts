...
export const APPS_POPULARES: Array<{ package_name: string; nombre: string }> = [
  { package_name: 'com.instagram.android', nombre: 'Instagram' },
  { package_name: 'com.zhiliaoapp.musically', nombre: 'TikTok' },
  { package_name: 'com.twitter.android', nombre: 'X (Twitter)' },
  { package_name: 'com.facebook.katana', nombre: 'Facebook' },
  { package_name: 'com.snapchat.android', nombre: 'Snapchat' },
  { package_name: 'com.google.android.youtube', nombre: 'YouTube' },
  { package_name: 'com.reddit.frontpage', nombre: 'Reddit' },
  { package_name: 'com.discord', nombre: 'Discord' },
];
